...
const LIST_URL = "https://www.igg.immo/fr/estates";

async function scrapeIgg(criteria) {
  const results = [];
  ...
  try {
    ...
    console.error("[igg] erreur:", err.response?.status || err.message);
  }

  return results;
}

module.exports = { scrapeIgg };
